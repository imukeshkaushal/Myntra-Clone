        ...
        >
          ...
          <DrawerContent p = {0}>
            ...
            <DrawerHeader padding={0}>
                ...
                <Flex bgColor={"#FFFDD0"} color= {"#E62044"} direction = "row-reverse" height = "30px" alignItems={"center"} fontSize={"12px"} pr={8}>SIGN UP / LOGIN</Flex>
            </DrawerHeader>
  
            <DrawerBody p={0}>
                <Flex justifyContent={"space-between"} p={2} pl = {4} pr={4}  alignItems= "center">
                    <Text fontWeight={"semibold"} onClick = {onClose}>Men</Text>
                    <ChevronRightIcon/>
                </Flex>

                <Flex justifyContent={"space-between"} p = {2} pl = {4} pr={4} alignItems= "center">
                    <Text fontWeight={"semibold"} onClick = {onClose}>Woman</Text>
                    <ChevronRightIcon/>
                </Flex>
